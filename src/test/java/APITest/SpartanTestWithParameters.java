...
public class SpartanTestWithParameters {
  ...
  */
    ...
    public void getSpartanIdPositiveTest(){
        ...
        Response response = given().accept(ContentType.JSON).and().pathParam("id",5) // This what Rest_assured supported
   ...
   */
    ...
    public void getSpartanIdNegativeTest(){
      ...
      ============================ This is the hardCoded query part =========================
    Given accept type is Json
    ...
    /*
     ============================ This is the dynamic query part =========================
     */
    @Test
    ...
    public void PositiveQueryParamTest3(){
        ...
        paramMaps.put("gender","Female");
        paramMaps.put("nameContains","E");

        Response response = given().accept(ContentType.JSON)
                .and().queryParams(paramMaps).when().get("/spartans/search");
